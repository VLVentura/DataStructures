import StronglyConnectedComponents.Edge;
import StronglyConnectedComponents.Graph;
import StronglyConnectedComponents.KosarajuAlgorithm;
import StronglyConnectedComponents.Vertex;
...
public class Program {
	public static void main(String[] args) {
		...
		KosarajuAlgorithm algo = new KosarajuAlgorithm(graph);

		System.out.println(algo.getCount());

		for(Vertex vertex: vertexList){
			System.out.println(vertex + " -> ComponentId: " + vertex.getComponentId());
		}
	}
}